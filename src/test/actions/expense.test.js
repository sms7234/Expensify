...
beforeEach((done)=>{
  const expensesData = {};
  expenses.forEach(({id, category, business, note, amount, purchaseDate, createdAt, updatedAt})=>{
    expensesData[id] = {category, business, note, amount, purchaseDate, createdAt, updatedAt}
  });
